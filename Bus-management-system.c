...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Manali Travels","Gwalior Travels","Tirupati Travels","Mahaveer Travels","Ansh Travels","D.S. Travels"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
getch();
    ...
    printf("\t----------------------------------------------------------------------------------------------------------\n");
    printf("\t\t\t Bus Management System project");
    getch();
    return 0;
}
...
printf("            *******WISH YOU FOR HAPPY AND SAFE JOURNEY********");
}
...
{
    printf("============================Enter the details for ticket number %d============================\n\n\n",i+1);
...
printf("\n\n");
    printf("======================================================================================================\n");
 printf("\t\t\t\tYour Payment has been Returned\t\t\t\n");
    printf("======================================================================================================\n");
}
    ...
    do
{
	...
	pword[i]='\0';
	i=0;
		if(strcmp(uname,"travel")==0 && strcmp(pword,"123456")==0)
	{
	printf("  \n\n\n       WELCOME TO OUR SYSTEM !!!! YOU LOGGED IN SUCCESSFUL");
	printf("\n\n\n\t\t\t\tPress any key to continue...");
	getch();                      //holds the screens
	break;
	}
	else
	{
		printf("\n        SORRY !!!!  INVALID USER AND PASSWORD");
		a++;
